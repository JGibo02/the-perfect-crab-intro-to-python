...
# loop.
#
# You can use it to find out what different expressions evaluate to, and
# generally play around with Python to see what it does.
...
# in Python are expressions, and we can combine data, operators, and function
